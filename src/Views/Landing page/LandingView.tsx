...
const LandingView:FC=()=> {
    return (
        <Box as="div" height="100vh" bg="black" position="relative">
  ...
  <Box mr="13">
    ...
    <Box as="a" href="/Login/" fontSize="25px" fontFamily="heading" fontWeight="bold" cursor="pointer" color="primary.100" m="3">Log in</Box>
  </Box>
</Flex> 
